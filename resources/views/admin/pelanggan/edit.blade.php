...
@section('konten')
   ...
   <form action="{{ route('pelanggan.update', $pl->id) }}" method="POST" enctype="multipart/form-data"> @csrf
    @method('PUT')
   <div class="form-group row">
       <label for="text" class="col-4 col-form-label">Kode Pelanggan</label> 
       <div class="col-8">
       ...
       <div class="col-8">
        ...
        @endphp
          <div class="custom-control custom-radio custom-control-inline">
            <input name="jk" id="{{ $g }}" type="radio" class="custom-control-input" value="{{ $g }}" {{ $cek }}> 
   ...
   <div class="form-group row">
        ...
        <input id="text5" name="foto" type="file" class="form-control">
            @if (!empty($pl->foto))
                <img src="{{ url('admin/image') }}/{{ $pl->foto }}" alt="" height="400">
            @endif
        </div>
    </div>
   <div class="form-group row">
