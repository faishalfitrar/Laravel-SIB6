                    ...
                    <div class="card rounded-3 mb-4">
                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="col-md-2 col-lg-2 col-xl-2">
                                @empty($details['foto'])
                                <img src="{{ url('admin/image/nophoto.jpg') }}" class="img-fluid rounded-3" alt="{{ $details['nama'] }}">
                                @else
            ...
            <div class="card-body p-4">
                <div class="row d-flex justify-content-between align-items-center">
                    <div class="col-md-6 col-lg-6 col-xl-6">
                        <button  type="button" class="btn btn-warning btn-block btn-lg" id="pay-button">Proceed to Pay</button>
                    </div>
